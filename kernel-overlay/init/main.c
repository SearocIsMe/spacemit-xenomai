...
void start_kernel(void)
{
	...
	pr_warn("BOOTDBG IMAGE_SIG=20260428-1625 commit=01f4a6a note=boot_evl_stopped_pcie_jpu_keep_bootcon_drm_pvr_qspi_emac_cifs_usb3hub_ehci_mvx_ccic_cpp_isp_vi_sdhci_mmc_trace_irq30_kthread_skip_percpu_cpuhp_skip_mmc0_signal_voltage_skip_bcache_all_mmc_mdelay_skip_boot_cd_irq_skip_mmc2_detect_skip_rproc_skip_hdmi_skip_cfg80211_quiet_irq_pipeline_clear_init_stall_restore_i2c8_pmic_pio_skip_hwlat_skip_wlan_v2d_hardirq_on_before_init_exec_mmap_irq_fix_elf_map_irq_fix_vdso_irq_fix_syscall_irq_fix_genpd_skip_poweroff_open_chdir_irq_fix_copy_strings_irq_fix_skip_genpd_unused_work_no_sunrpc_nfs_force_mmc0_330_runtime_syscall_local_irq_fix_no_stream_parser_usercopy_irq_fix_no_sound_no_husb239_force_i2c8_pmic_pio_always_skip_mmc0_poll_after_attach_deferred_probe_no_flush_trace_skip_cacheinfo_sysfs_pxa_uart_rx_poll_warn_shell_marker_no_devtmpfs_prints\n");
	early_security_init();
