...
static int __init spacemit_wlan_driver_init(void)
{
	pr_info("BOOTDBG skipping spacemit WLAN pwrseq init for boot debug\n");
	return 0;
}

static void __exit spacemit_wlan_driver_exit(void)
{
}

module_init(spacemit_wlan_driver_init);
module_exit(spacemit_wlan_driver_exit);
